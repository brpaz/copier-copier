...
[![Build Status](https://img.shields.io/github/actions/workflow/status/{{ github_repo }}/ci.yml?branch=main&style=for-the-badge)](https://github.com/{{ github_repo }}/actions)
...
```bash
copier copy gh:{{github_repo}} /path/to/your/new/project
```
